...
feature -- Test routines
	...
	graph_tests
		...
		local
			...
			l_png: PLAIN_TEXT_FILE --RAW_FILE
		...
		do
			...
			l_graph.statement_list.force (l_node_8)
				...
				-- Edge 1
			create l_edge_1.make_as_digraph_with_nodes (l_node_0, l_node_2)
			...
			l_graph.statement_list.force (l_edge_1)
				...
				-- Edge 2
			create l_edge_2.make_as_digraph_with_nodes (l_node_0, l_node_1)
			l_edge_2.set_label ("SS(S)")
			l_graph.statement_list.force (l_edge_2)
				...
				-- Edge 3
			create l_edge_3.make_as_digraph_with_nodes (l_node_1, l_node_3)
			l_edge_3.set_label ("S($end)")
			l_graph.statement_list.force (l_edge_3)
				...
				-- Edge 4
			create l_edge_4.make_as_digraph_with_nodes (l_node_2, l_node_6)
			...
			l_graph.statement_list.force (l_edge_4)
				...
				-- Edge 5
			create l_edge_5.make_as_digraph_with_nodes (l_node_2, l_node_5)
			...
			l_graph.statement_list.force (l_edge_5)
				...
				-- Edge 6
			create l_edge_6.make_as_digraph_with_nodes (l_node_2, l_node_4)
			...
			l_graph.statement_list.force (l_edge_6)
				...
				-- Edge 7
			create l_edge_7.make_as_digraph_with_nodes (l_node_5, l_node_7)
			...
			l_graph.statement_list.force (l_edge_7)
				...
				-- Edge 8
			create l_edge_8.make_as_digraph_with_nodes (l_node_5, l_node_5)
			...
			l_graph.statement_list.force (l_edge_8)
				...
				-- Edge 9
			create l_edge_9.make_as_digraph_with_nodes (l_node_6, l_node_6)
			...
			l_graph.statement_list.force (l_edge_9)
				...
				-- Edge 10
			create l_edge_10.make_as_digraph_with_nodes (l_node_6, l_node_5)
			...
			l_graph.statement_list.force (l_edge_10)
				...
				-- Edge 11
			create l_edge_11.make_as_digraph_with_nodes (l_node_7, l_node_8)
			...
			l_graph.statement_list.force (l_edge_11)
				...
				-- Edge 12
			create l_edge_12.make_as_digraph_with_nodes (l_node_7, l_node_5)
			...
			l_graph.statement_list.force (l_edge_12)
				...
				-- Edge 13
			create l_edge_13.make_as_digraph_with_nodes (l_node_8, l_node_6)
			...
			l_graph.statement_list.force (l_edge_13)
				...
				-- Edge 14
			create l_edge_14.make_as_digraph_with_nodes (l_node_8, l_node_5)
			...
			create l_env
			output_of_command ("bin\dot.exe graph_test.txt -Tpng>graph_test.png", l_env.Current_directory_name_representation).do_nothing
--			l_graph_text := output_of_command ("bin\dot.exe graph_test.txt -Tpng", l_env.Current_directory_name_representation)
--			assert_strings_equal ("graph_text", graph_test_text, l_graph.graph_out)
		end

feature {NONE} -- Test Support

	graph_test_text: STRING = "[
